...
function extractContent() {
  const article = document.querySelector('article') || document.querySelector('.fck_detail') || document.querySelector('.singular-content') || document.querySelector('.detail-content');
  if (article) {
